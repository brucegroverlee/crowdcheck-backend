...
import { MySqlPeopleRepository } from "../gateways/MySqlPeopleRepository";
...
const peopleRepository = new MySqlPeopleRepository();
export const createPersonController = controller(peopleRepository);